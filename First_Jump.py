...
# Game Variables - <editor-fold desc="Game Setup/Var">
pygame.init()
...
# <editor-fold desc="Game Backgrounds">
...
# <editor-fold desc="Menu Objects">
# Game Title Text (First Jump)
def title_text():
    title_text_surf = pixel_font(55).render("First Jump", False, white).convert_alpha()
...
# Menu Character Art
def menu_art():
    menu_player_art = pygame.image.load("FirstJumpAssets/PlayerMenu.png").convert_alpha()

    menu_player_art_scaled = pygame.transform.scale(menu_player_art, ((16 * 10), (12 * 10)))
    menu_player_art_rect = menu_player_art_scaled.get_rect(center=(640, 360))

    scn.blit(menu_player_art_scaled, menu_player_art_rect)
...
def start_menu_game_desc_text():
    game_desc_text_render_1 = pixel_font(35).render("Avoid enemies at all costs!", False, white).convert_alpha()
    game_desc_text_render_2 = pixel_font(35).render("  Failure is not an option!", False, white).convert_alpha()
...
def controls_text():
    #   Controls line 1
    controls_text_render_1 = pixel_font(35).render("Controls :", False, white).convert_alpha()
...
def start_menu_play_text():
    menu_play_text_render = pixel_font(40).render("Press [SPACE] To Start!", False, white).convert_alpha()
...
# <editor-fold desc="Game Over Menu">

# Display Game Over Text
def you_lost_text():
    menu_you_lost_text_surf = pixel_font(40).render("You Got Hit! Game Over!", False, white)
    menu_you_lost_text_rect = menu_you_lost_text_surf.get_rect(center=(640, 160))
...
def final_score_text():
    # Display Final Score
    final_score_render_1 = pixel_font(35).render(f"Your Score Was:", False, white).convert_alpha()
    final_score_render_2 = pixel_font(35).render(f"{score}", False, white).convert_alpha()
    final_score_render_3 = pixel_font(35).render(f"{score_comment}", False, white).convert_alpha()
...
def play_again_text():
    menu_play_again_text_render = pixel_font(40).render("Press [SPACE] To Play Again", False, white)
    menu_play_again_text_rect = menu_play_again_text_render.get_rect(midbottom=(640, 700))
...
# Score While Playing Text
def active_game_score_text():
    score_text_render = pixel_font(20).render(f"Score: {score}", False, white).convert_alpha()
...
# <editor-fold desc="Player Assets and Functions">
# Load Player Sprite Images -
plr_run_sprite_sheet_img = pygame.image.load("FirstJumpAssets/PlayerSpriteSheet.png").convert_alpha()
plr_jump_sprite_sheet_img = pygame.image.load("FirstJumpAssets/PlayerJump.png").convert_alpha()
plr_death_sprite_sheet_img = pygame.image.load("FirstJumpAssets/PlayerDeath.png").convert_alpha()
...
def get_plr_sprite(sprite_sheet, frame, width, height, scale):
    ...
    plr_scaled_surf = pygame.transform.scale(plr_surf, (width * scale, height * scale))
    return plr_scaled_surf


# </editor-fold>

# Jump Animation For Start Menu - <editor-fold desc="Start Menu - Player Spinning Animation">
# Player Jump Rect - Scaled to 10x rather than 4x for game
plr_start_rect = (get_plr_sprite(plr_jump_sprite_sheet_img, 0, 15, 15, 10)).get_rect()
...
plr_start_frame = 0
# Create Player Animation image list -
for x in range(plr_start_anim_steps):
    plr_start_anim_list.append(get_plr_sprite(plr_jump_sprite_sheet_img, x, 15, 15, 10))
# </editor-fold>

# <editor-fold desc="Game - Player Running Animation w Rect">
# Player Run Rect (for collisions)
plr_run_rect = (get_plr_sprite(plr_run_sprite_sheet_img, 0, 14, 18, 4)).get_rect()
...
for x in range(plr_run_anim_steps):
    plr_run_anim_list.append(get_plr_sprite(plr_run_sprite_sheet_img, x, 14, 18, 4))
# </editor-fold>

# <editor-fold desc="Game - Player Jump w Rect">
# Player Jump Rect (for collisions)
plr_jump_rect = (get_plr_sprite(plr_jump_sprite_sheet_img, 0, 15, 15, 4)).get_rect()
...
for x in range(plr_jump_anim_steps):
    plr_jump_anim_list.append(get_plr_sprite(plr_jump_sprite_sheet_img, x, 15, 15, 4))
# </editor-fold>

# Game Over Player Death Animation - <editor-fold desc="Game Over - Player Death Animation">
# Player Rect
plr_death_rect = (get_plr_sprite(plr_death_sprite_sheet_img, 0, 16, 19, 10)).get_rect()
...
for x in range(0, 4):
    plr_death_anim_list.append(get_plr_sprite(plr_death_sprite_sheet_img, x, 16, 19, 10))
# </editor-fold>

# Enemy Load / Functions - <editor-fold desc="Enemy Assets/Functions">
# Enemy Sprite Sheet load
gs_sprite_sheet_img = pygame.image.load("FirstJumpAssets/SlimeGreenSpriteSheet.png").convert_alpha()
ps_sprite_sheet_img = pygame.image.load("FirstJumpAssets/SlimePurpleSpriteSheet.png").convert_alpha()
b_sprite_sheet_img = pygame.image.load("FirstJumpAssets/BirdSpriteSheet.png").convert_alpha()
...
def slime_sprite(sprite_sheet, frame, width, height, scale):
    ...
    s_scaled_flip = pygame.transform.scale(s_flip, (width * scale, height * scale))
...
# Enemy Spawning / Movement -      <editor-fold desc="Enemy Spawning Function">
# Spawning Variables =
enemy_rect_list = []
...
# Green Slime Animation Variables -      <editor-fold desc="Green Slime">
gs_anim_list = []
gs_anim_steps = 4
...
# Purple Slime Animation Variables -     <editor-fold desc="Purple Slime">
ps_anim_list = []
ps_anim_steps = 4
...
# Bird Animation Variables -        <editor-fold desc="Bird">
b_anim_list = []
b_anim_steps = 9
...
# Game Loop Variables - <editor-fold desc="Game Loop Variables">
running = True
main_menu = True
game_active = False
game_over = False
...
while running:
    ...
    # Event Handler - <editor-fold desc="Event Handler">
    ...
    # Main Menu Screen - <editor-fold desc="Main Menu">
    if main_menu:
    ...
    # Game Over Screen - <editor-fold desc="Game Over">
    if game_over:
    ...
    # Game Active Loop - <editor-fold desc="Game Active">
    if game_active:

        # Game Setup - <editor-fold desc="Game Setup">
        ...
        # Collisions - <editor-fold desc="Collisions">
        ...
        # Update Green Slime Animation - <editor-fold desc="Green Slime">
        ...
        # Update Purple Slime Animation - <editor-fold desc="Purple Slime">
        ...
        # Update Bird Animation -  <editor-fold desc="Bird">
